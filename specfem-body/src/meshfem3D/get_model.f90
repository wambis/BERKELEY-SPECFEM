...
!=====================================================================
  ...
  double precision :: rho,dvp,scaleval
  double precision :: vpv,vph,vsv,vsh,eta_aniso
  double precision :: r,r_prem,moho,theta,phi,lat,lon
  integer :: i,j,k,i_sls
  ...
  do k=1,NGLLZ
    do j=1,NGLLY
      do i=1,NGLLX
        ...
        if( vpv < TINYVAL ) then
          print*,'error vpv: ',vpv,vph,vsv,vsh,rho,elem_in_mantle,CRUSTAL
  ...
  ! gets point's positiontheta/phi, lat/lon
...
!  if(lat>0.and.lat<1)then
!  if(lon>0.and.lon<1)then
!   scaleval=dsqrt(PI*GRAV*RHOAV)
!   print*,r*r_earth,vsv*scaleval,vsv/scaleval
!  endif
!  endif
