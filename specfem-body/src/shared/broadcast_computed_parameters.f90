...
!=====================================================================
  ...
  ! Modified <FM> April 2021 
  !integer, parameter :: nparam_dp = 32
  integer, parameter :: nparam_dp = 37
...
!   Modified <FM> April 2021 (included: SOURCE_T* and TAU)
  ...
  if( myrank /= 0 ) then
    ...
    ! Added <FM> April 2021
    SOURCE_T1 = bcast_double_precision(33)
    SOURCE_T2 = bcast_double_precision(34)
    SOURCE_T3 = bcast_double_precision(35)
    SOURCE_T4 = bcast_double_precision(36)
    TAU = bcast_double_precision(37)
    ! ============================
